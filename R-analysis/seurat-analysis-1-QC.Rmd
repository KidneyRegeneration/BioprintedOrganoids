...
'hand' - traditional hand made organoids using a centrifuge.

'dots' - single deposition bioprinted organonids to replicate the handmade protocol.

'line' - line organoids, where the same number of cells as 'dots' are spread out over a thing line with movement:extrusion ration of 40:1 (distance moved : syringe plunger displacement)
...
#sets.integrated <- integrate_sets(sets.list[c(1,3)])
#saveRDS(object = sets.integrated, file = "output/integrated-dots-hand.RDS")

# for dots-line

#sets.integrated <- integrate_sets(sets.list[c(1,2)])
#saveRDS(object = sets.integrated, file = "output/integrated-dots-line.RDS")
